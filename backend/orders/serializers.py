...
class CreateOrderSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Get delivery fee from farmer's profile
        try:
            ...
            # ✅ Calculate delivery partner commission (percentage of delivery fee)
            commission_percent = farmer_profile.delivery_partner_commission_percent
            delivery_partner_commission = (delivery_fee * commission_percent) / 100
            
        except FarmerProfile.DoesNotExist:
            delivery_fee = 50.00
            delivery_partner_commission = 5.00  # 10% of 50 = 5
            print(f"⚠️ Warning: Farmer {farmer.id} has no profile, using defaults")
        
        validated_data['delivery_fee'] = delivery_fee
        validated_data['delivery_partner_commission'] = delivery_partner_commission
